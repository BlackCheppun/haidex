            ...
            <div className='Apropos-Page-Section2'>
                ...
                <div className='Apropos-Page-Section2-container'>
                    ...
                    <div className='Apropos-section2-Section-Text'>
                        ...
                        <p> Notre équipe se compose de <span>40 collaborateurs</span> parmi lesquels plus de: <span>25 techniciens.</span> qualifiés. Certains d'entre eux occupent désormais des fonctions de chef d'équipe ou chef de chantier. Par ailleurs, nous comptons un chargé  d'affaires, supervisant deux conducteurs de travaux</p>
